...
function genQrCode() {
	...
	console.log( nombre, apellido, email, tel, edad, clasesparaadultos, clasesparaninos, clasesdefreestylesalom, clasesenescuelas, codigoseguridad);
...
$("#btnSave").click(function () {
	const frame = document.getElementById('previewIframe'),
		divhtml = document.querySelector("#capture");
	var element = jQuery('#previewIframe').contents().html();

	var delayInMilliseconds = 5000; //1 second
	// const element = document.getElementById('previewIframe').contentWindow.document.body,
	//setTimeout(function() {
